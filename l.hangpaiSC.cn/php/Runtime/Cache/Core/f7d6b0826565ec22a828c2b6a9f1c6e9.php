<?php if (!defined('THINK_PATH')) exit();?><div class="modal fade announce" id="AnnounceModel" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <?php if(($announce["link"]) != ""): ?><a type="button" data-role="set-announce-arrive" data-url="<?php echo ($announce['link']); ?>" class="btn btn-default announce-btn">
                        查看详情
                    </a>
                    <?php else: ?>
...
<?php if(strlen($announce['content'])>400){ ?>
<style>
...
<script>
    var announce_id="<?php echo ($announce['id']); ?>";
    $(function(){
        $('#AnnounceModel').modal({
            backdrop:'static',
            keyboard:false,

            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-purple bold uppercase">想天科技</span>
                    </div>
                ...
                <div class="portlet-body">
                    <div class="row">
                        <div class="col-md-5">
                            <a target="_blank" href="http://zhiguo.opensns.cn"><img src="/Application/Admin/Static/images/zhiguo.png"></a>
                        </div>
                        <div  class="col-md-7">
                            <div class="">
                                <h4 style="text-align: center">OpenSNS相关资源</h4>
                                <hr>
                                </div>
                            <div class="col-md-4">
...
//        nav_obj.trigger("click");
    ...
    <script src="/Application/Admin/Static/bootstrap/plugins/counterup/jquery.waypoints.min.js" type="text/javascript"></script>
    <script src="/Application/Admin/Static/bootstrap/plugins/counterup/jquery.counterup.min.js" type="text/javascript"></script>
    <link href="/Application/Admin/Static/bootstrap/plugins/metro/MetroJs.min.css" type="text/css" rel="stylesheet">
    <script src="/Application/Admin/Static/bootstrap/plugins/metro/MetroJs.min.js" type="text/javascript"></script>
    <script type="text/javascript" src="/Application/Admin/Static/js/highcharts.js"></script>
    <script type="text/javascript" src="/Application/Admin/Static/adminlte/plugins/jQueryUI/jquery-ui.min.js"></script>

    <script src="/Application/Admin/Static/js/jquery.simple-color.js"></script>
    <link rel="stylesheet" href="/Application/Admin/Static/css/tile.css" media="all">
    ...
    <script>
        ...
        $('[data-role=saveCountSetting]').click(function () {
            $.post("/admin.php?s=/index/index.html", {count_day: $('[name=count_day]').val()}, function (msg) {
                handleAjax(msg);
            });
        });
